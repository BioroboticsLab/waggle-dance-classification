...
model.fit_generator(generator=datagen.flow(X_train, Y_train, batch_size=32), nb_epoch=numberOfEpochs, samples_per_epoch=train_samples, verbose=1, validation_data=(X_test, Y_test), class_weight={0:1, 1:2})
